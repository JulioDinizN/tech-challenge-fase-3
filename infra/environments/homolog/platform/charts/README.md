...
Rebuild with `scripts/maintenance/vendor-nginx-chart.py --chart <upstream.tgz> --schema <_definitions.json> --output infra/environments/homolog/platform/charts/nginx-ingress-2.6.1.tgz`. The script verifies exact SHA256 checksums for both inputs. Schema source: https://raw.githubusercontent.com/nginxinc/kubernetes-json-schema/master/v1.36.1/_definitions.json.
